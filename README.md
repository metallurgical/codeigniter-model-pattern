...
12. [max](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#l-max-fields--where-table--)
13. [min](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#m-min-fields--where-table--)
14. [avg](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#n-avg-fields--where-table--)
16. [sum](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#o-sum-fields--where-table--)
17. [count](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#p-count--where-table--)
18. [where](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#q-where-arrvalue--table--)
19. [or_where](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#r-or_where-arrvalue--table--)
20. [having](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#s-having-arrvalue--table--)
21. [or_having](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#t-or_having-arrvalue--table--)
22. [where_in](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#u-where_in-arrvalue--table--)
23. [or_where_in](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#v-or_where_in-arrvalue--table--)
24. [where_not_in](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#w-where_not_in-arrvalue--table--)
25. [or_where_not_in](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#x-or_where_not_in-arrvalue--table--)
26. [like](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#y-like-arrvalue--table--)
27. [like_before](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#z-like_before-arrvalue--table--)
28. [like_after](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#aa-like_after-arrvalue--table--)
29. [or_like](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#ab-or_like-arrvalue--table--)
30. [or_like_before](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#ac-or_like_before-arrvalue--table--)
31. [or_like_after](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#ad-or_like_after-arrvalue--table--)
32. [not_like](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#ae-not_like-arrvalue--table--)
33. [not_like_before](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#af-not_like_before-arrvalue--table--)
34. [not_like_after](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#ag-not_like_after-arrvalue--table--)
35. [or_not_like](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#ah-or_not_like-arrvalue--table--)
36. [or_not_like_before](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#ai-or_not_like_before-arrvalue--table--)
37. [or_not_like_after](https://github.com/metallurgical/codeigniter-model-pattern/blob/master/README.md#aj-or_not_like_after-arrvalue--table--)
